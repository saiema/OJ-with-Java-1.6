 ...
 */
  ...
  final public ClassDeclaration TypeDeclaration(ClassEnvironment env) throws ParseException {
    ...
    if (jj_2_5(2147483647)) {
      p1 = ClassDeclarationWithMGL(env, mgl);
    } else if (jj_2_6(2147483647)) {
      md = EnumDeclarationWithMGL(env, mgl);
          p1 = new ClassDeclaration(md);
    } else {
      p1 = InterfaceDeclarationWithMGL(env, mgl);
    }
        result = p1;
...
//+++++++++++++++++++++++++++++++++++++++++++++++++added (11/09/14) [simon]
  final public ClassDeclaration ClassDeclarationWithMGL(ClassEnvironment env, MutableInteger mgl) throws ParseException {
    ModifierList                    p1;
    ClassDeclaration            p2;
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//+++++++++++++++++++++++++++++++++++++++++++added (11/09/14) [simon]
  final public ClassDeclaration UnmodifiedClassDeclarationWithMGL(ClassEnvironment env, MutableInteger mgl) throws ParseException {
    ClassDeclaration            result;
    String                                      p1;
    String                                      tp;
    TypeName[]                          p2;
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//++++++++++++++++++++++++++++++++added (11/09/14) [simon]
  final public MemberDeclarationList ClassBodyWithMGL(ClassEnvironment env, MutableInteger mgl) throws ParseException {
    MemberDeclarationList       p1;
        Literal                                 mut = null;
        String                                  comment;
    DebugOut.println( "#ClassBody()" );
    jj_consume_token(LBRACE);
    if (jj_2_9(2) && (mgl != null && mgl.intValue() == -1)) {
      jj_consume_token(MUT_GEN_LIMIT);
      if (jj_2_8(2)) {
        mut = Literal();
                                                                                                                                mgl.setIntValue(Integer.parseInt(mut.toString()));
      } else {
        ;
      }
    } else {
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++added (11/09/14) [simon]
  final public MemberDeclaration EnumDeclarationWithMGL(ClassEnvironment env, MutableInteger mgl) throws ParseException {
        int modifierInt = 0;
    ...
    jj_consume_token(LBRACE);
    if (jj_2_17(2) && (mgl != null && mgl.intValue() == -1)) {
      jj_consume_token(MUT_GEN_LIMIT);
      if (jj_2_16(2)) {
        mut = Literal();
                                                                                                                                mgl.setIntValue(Integer.parseInt(mut.toString()));
...
// ++++++++++++++++++++++++added (16/09/14) [simon]
  final public StatementList MethodBodyWithMGL(Environment env, MutableInteger mgl) throws ParseException {
    StatementList               p1;
        Literal                         mut = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case LBRACE:
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//+++++++++++++++++++++++++++++++++++added (11/09/14) [simon]
  final public ClassDeclaration InterfaceDeclarationWithMGL(ClassEnvironment env, MutableInteger mgl) throws ParseException {
    ModifierList                p1;
    ClassDeclaration            p2;
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//++++++++++++++++++++++++++++++++++++++++++added (11/09/14) [simon]
  final public ClassDeclaration UnmodifiedInterfaceDeclarationWithMGL(ClassEnvironment env, MutableInteger mgl) throws ParseException {
    ClassDeclaration            result;
    String                      p1;
    TypeName[]                  p2;
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//++++++++++++++++++++++++++++++++++++++++++added (11/09/14) [simon]
  final public MemberDeclarationList InterfaceBodyWithMGL(ClassEnvironment env, MutableInteger mgl) throws ParseException {
    MemberDeclarationList       p1;
        Literal                                 mut = null;
    jj_consume_token(LBRACE);
    if (jj_2_30(2) && (mgl != null && mgl.intValue() == -1)) {
      jj_consume_token(MUT_GEN_LIMIT);
      if (jj_2_29(2)) {
        mut = Literal();
                                                                                                             mgl.setIntValue(Integer.parseInt(mut.toString()));System.out.println("mutGenLimit: " + mut.toString());
      } else {
        ;
      }
    } else {
...
//-----------------------------------------------------------------------
  ...
  final public ConstructorDeclaration ConstructorDeclaration(Environment base_env) throws ParseException {
    ...
    jj_consume_token(RBRACE);
        ...
        if (comments != null) result.setComment(comments);
        {if (true) return result;}
    throw new Error("Missing return statement in function");
  }
...
// ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// +++++++++++++++++++++++++++++++added (17/09/14) [simon] {copied from old OJ}
  final public TypeName TypeOptionalComments(Environment env, boolean checkForComments) throws ParseException {
    TypeName                    result;
    String                          p1;
    Hashtable                   p2;
    int                             p3;
...
// ----------------------------------------------------------------------------
  final public TypeName TypeWithoutDimensions(Environment env) throws ParseException {
    String                          p1;
    Hashtable                   p2;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case BOOLEAN:
  ...
  final public String NameWithoutBrackets() throws ParseException {
    String               p1, p2;
...
// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// ++++++++++++++++++++++++++++++++added (22/09/14) [simon] {copied from old OJ}
  final public String SHIFTOP() throws ParseException {
 String op = null;
    if (getToken(1).image == "<" && getToken(2).image == "<") {
      jj_consume_token(LT);
      jj_consume_token(LT);
           {if (true) return "<<";}
    } else if (getToken(1).image == ">" && getToken(2).image == ">") {
      jj_consume_token(GT);
      jj_consume_token(GT);
           op = ">>";
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  final public Expression PrimaryExpression(Environment env) throws ParseException {
    ...
    while (true) {
      ...
      if (jj_2_61(2147483647)) {
        ...
        case LPAREN:
          p5 = Arguments(env);
                        //FIX FOR PrimaryPrefix returning a Variable+++++
                        String name = null;
                        Expression expr = null;
                        if (result instanceof Variable) {
                                name = ((Variable)result).toString();
                        } else {
                                FieldAccess base = (FieldAccess) result;
                                expr = base.getReferenceExpr();
                                name = base.getName();
                        }
                        //------------------------------------------------
  ...
  final public Expression PrimaryPrefix(Environment env) throws ParseException {
    ...
    default:
      ...
      {if (true) return p1;}
         ...
         //FIX FOR VARIABLE PARSED AS FIELDACCESS++++++++++++++++++++++++++++++++++++++++
         if (((FieldAccess)p1).getReferenceExpr() == null) {
                 OJField[] fields = env.lookupClass(env.currentClassName()).getAllFields();
         String p1Name = ((FieldAccess)p1).getName();
         boolean found = false;
         for (OJField f : fields) {
                         found = f.getName().compareTo(p1Name) == 0;
                         if (found) break;
         }
         if (!found) {
                         p1 = new Variable(p1Name);
                 }
     }
         //-------------------------------------------------------------------------------
         {if (true) return p1;}
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++added (08/09/14) [simon]
  final public StatementList BlockedBodyWithMGL(Environment env, MutableInteger mutGenLimit) throws ParseException {
    StatementList               p1;
        Literal                         mut = null;
    jj_consume_token(LBRACE);
    if (jj_2_71(2) && (mutGenLimit != null && mutGenLimit.intValue() == -1)) {
      jj_consume_token(MUT_GEN_LIMIT);
      if (jj_2_70(2)) {
        mut = Literal();
      } else {
    ...
    p1 = BlockOrStatementListOpt(env);
         String afterComment = getComment();
    jj_consume_token(RBRACE);
           if (mut != null) {
                  mutGenLimit.setIntValue(Integer.parseInt(mut.toString()));
           }
           p1.setAfterComment(afterComment);
           {if (true) return p1;}
    throw new Error("Missing return statement in function");
  }
 ...
 */
  ...
  final public LabeledStatement LabeledStatement(Environment env) throws ParseException {
    ...
    jj_consume_token(COLON);
    p2 = Statement(env);
         result = new LabeledStatement( p1, p2 );
         result.setComment(comment);
         {if (true) return result;}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Block Block(Environment env) throws ParseException {
    ...
    jj_consume_token(RBRACE);
         result = new Block( p1 );
         result.setAfterComment(afterComment);
         {if (true) return result;}
    throw new Error("Missing return statement in function");
  }
    ...
    if (jj_2_80(2)) {
      ...
      ;
        ...
        res.setComment(comment);
                {if (true) return res;}                                                                                                                     //modified (08/09/14) [simon]
  ...
  final public SwitchStatement SwitchStatement(Environment env) throws ParseException {
    ...
    jj_consume_token(RBRACE);
                ...
                swstmt.setComment(comment);
                {if (true) return swstmt;}                                                                                                                  //modified (08/09/14) [simon]
  ...
  final public IfStatement IfStatement(Environment env) throws ParseException {
    ...
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case LBRACE:
      p2 = BlockedBodyWithMGL(env, blockedIfMGL);
          true_part = p2;
      break;
    default:
      if (jj_2_88(1)) {
    ...
    default:
      ;
                ...
                ifstmnt.setComment(comment);
                {if (true) return ifstmnt;}                                                                                                                                 //modified (08/09/14) [simon]
  ...
  final public WhileStatement WhileStatement(Environment env) throws ParseException {
    ...
    if (jj_2_91(2)) {
      ...
      if (jj_2_90(2)) {
        singleStatementMGL = Literal();
                                                                                                                      blockedWhileMGL.setIntValue(-2);System.out.println("mutGenLimit: " + singleStatementMGL.toString());
      } else {
        ;
      }
    } else {
    ...
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case LBRACE:
      p2 = BlockedBodyWithMGL(env,  blockedWhileMGL);
          body = p2;
      break;
    default:
      if (jj_2_92(1)) {
        ...
        throw new ParseException();
                ...
                whlStmnt.setComment(comment);
                {if (true) return whlStmnt;}                                                                                                                                //modified (08/09/14) [simon]
  ...
  final public DoWhileStatement DoWhileStatement(Environment env) throws ParseException {
    ...
    if (jj_2_95(2)) {
      ...
      ;
                ...
                doWhlStmnt.setComment(comment);
                {if (true) return doWhlStmnt;}
    throw new Error("Missing return statement in function");
  }
  ...
  final public ForStatement ForStatement(Environment env) throws ParseException {
    ...
    if (jj_2_100(2)) {
      ...
      if (jj_2_99(2)) {
        singleStatementMGL = Literal();
                                                                                     blockedForMGL.setIntValue(-2);System.out.println("mutGenLimit: " + singleStatementMGL.toString());
      } else {
        ;
      }
    } else {
    ...
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case LBRACE:
      p6 = BlockedBodyWithMGL(env, blockedForMGL);
          body = p6;
      break;
    default:
      if (jj_2_101(1)) {
...
/* Annotation Types. */
  ...
  private boolean jj_3_9() {
    if (jj_scan_token(MUT_GEN_LIMIT)) return true;
    Token xsp;
    xsp = jj_scanpos;
  ...
  private boolean jj_3R_117() {
    ...
    jj_semLA = getToken(1).image == "<" && getToken(2).image == "<";
