...
public class Logic {
	...
	private List<VarExpression> vars;
	private TruthTable table;//a variable of TruthTable
	
	private final static boolean[] TF=new boolean[]{true, false};
	 ...
	 * @return the vars
	 */
	public List<VarExpression> getVars() {
		return vars;
	}
	 ...
	 */
	public void setVars(List<VarExpression> vars) {
		this.vars = vars;
	}
